function [updated_w,del_cur_class_w] = update_w_featsel(data,data_probs,resp,cur_w,cur_w_featsel,targets_1inK,eta1)
...
for m = 1:M
	...
	del_cur_class_w = cur_w_featsel.*sum(wtd_data_points);
